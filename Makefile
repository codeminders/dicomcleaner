...
PIXELMEDCODESIGNERALIAS = "PixelMed Publishing's COMODO CA Limited ID"
PIXELMEDCODESIGNEROPTIONS = -storetype pkcs12 -tsa http://timestamp.comodoca.com -digestalg SHA1
...
webstart/pixelmed_codec.jar:	lib/additional/pixelmed_codec.jar
	mkdir -p webstart
	cp $< $@
	jarsigner -keystore ${PIXELMEDCODESIGNERKEYSTORE} ${PIXELMEDCODESIGNEROPTIONS} $@ ${PIXELMEDCODESIGNERALIAS}
	jarsigner -verify $@
