...
public class ProcessReceivedWholeSlideImagesMakeTiledPyramidAndSend extends InstanceReceiver {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/apps/ProcessReceivedWholeSlideImagesMakeTiledPyramidAndSend.java,v 1.1 2018/04/01 18:14:03 dclunie Exp $";
...
System.err.println("doSomethingWithReceivedDicomFile(): "+receivedFileName+" received from "+sourceApplicationEntityTitle+" in "+transferSyntaxUID+" is "+sopClassUID);
		...
		if (ok) {
			...
			if (setOfDicomFiles != null & setOfDicomFiles.size() > 0) {
				if (new StorageSOPClassSCU(remoteHost,remotePort,remoteAETitle,ourCallingAETitle,setOfDicomFiles,0,
