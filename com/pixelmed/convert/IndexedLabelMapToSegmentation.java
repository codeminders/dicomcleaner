...
public class IndexedLabelMapToSegmentation {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/convert/IndexedLabelMapToSegmentation.java,v 1.31 2018/06/22 17:15:10 dclunie Exp $";
...
//System.err.println("Not adding line = "+line);
	...
	protected void addSegmentSequenceItem(int segmentNumber,SequenceAttribute saSegmentSequence,int index,LabelInformation labelinfo) throws DicomException {
		...
		String segmentLabel = labelinfo == null ? (index + ": Topography unknown") : getStringNoLongerThan64TruncatedIfNecessary(index + ": " + labelinfo.codeMeaning);		// include original index in label since no longer used as segment number (000720)
