...
public class GetSOPClassSCU extends SOPClass {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/GetSOPClassSCU.java,v 1.26 2018/03/31 05:46:59 dclunie Exp $";
				...
				if (pdv.isCommand()) {
					...
					if (pdv.isLastFragment()) {
						...
						if (command == MessageServiceElementCommand.C_STORE_RQ) {
							...
							slf4jlogger.trace("CGetResponseOrCStoreRequestHandler.sendPDataIndication(): C-GET-RSP");
