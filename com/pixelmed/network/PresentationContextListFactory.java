...
public class PresentationContextListFactory {
	...
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/PresentationContextListFactory.java,v 1.24 2018/04/01 18:05:01 dclunie Exp $";
	...
	private static final byte incrementPresentationContextID(byte presentationContextID) throws DicomNetworkException {
		if (slf4jlogger.isDebugEnabled()) slf4jlogger.debug("PresentationContextListFactory.incrementPresentationContextID(): starting with {}",(((int)presentationContextID) & 0xff));
...
//		}
	...
	static public LinkedList createNewPresentationContextList(Set<String> setOfSOPClassUIDs,int compressionLevel,
		...
		slf4jlogger.debug("PresentationContextListFactory.createNewPresentationContextList():");
		...
		if (slf4jlogger.isDebugEnabled()) slf4jlogger.debug("PresentationContextListFactory.createNewPresentationContextList(): setOfSOPClassUIDs.size() = "+setOfSOPClassUIDs.size());
