...
public class StorageSOPClassSCP extends SOPClass implements Runnable {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/StorageSOPClassSCP.java,v 1.79 2018/03/31 05:46:59 dclunie Exp $";
						...
						if (pdv.isLastFragment()) {
							...
							if (status != ResponseStatus.Success) {
								...
								while ((responseIdentifierList = queryResponseGenerator.next()) != null) {
									slf4jlogger.debug("CompositeCommandReceivedPDUHandler.sendPDataIndication(): Building and sending pending response {}",responseIdentifierList.toString());
